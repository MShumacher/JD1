package com.itacademy.jd1.part1.task22;
...
public class TimeInterval {
	...
	public void printTimeInSecond() {
		System.out.println("Промежуток в секундах: " + this.getSecond());
	};

	public void printTime() {
		System.out.println(String.format("Промежуток: %s часов, %s минут, %s секунд", this.hour, this.min, this.sec));
	};
